 ...
 */
 ...
 public class AirportManager {
     ...
     public void addAirport() {
         try {
             ...
             Airport airport = new Airport(name, icao, latitude, longitude, fuelType, key);
 ...
 class Airport {
     ...
     public Airport(String name, String icao, double latitude, double longitude, int fuelType, int key) {
         this.name = name;
         this.icao = icao;
     ...
     public String toString() {
         return String.format("Airport [Key: %d, Name: %s, ICAO: %s, Latitude: %.4f, Longitude: %.4f, Fuel Type: %d]",
                 key, name, icao, latitude, longitude, fuelType);
     }
 }
